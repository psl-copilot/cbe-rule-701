...
const getRuleConfig = (): RuleConfig => {
  return {
    id: '701@1.0.0',
    cfg: '1.0.0',
    desc: 'Transaction amount vs regulatory threshold - arif bhai',
    config: {
      bands: [
        {
...
const getMockRequest = (): RuleRequest => {
  const quote = {
    ...
    networkMap: JSON.parse(
      '{"cfg":"1.0.1","name":"Public E2E Test Network Map","active":true,"messages":[{"id":"005@1.0.0","cfg":"1.0.0","txTp":"pacs.002.001.12","typologies":[{"id":"typology-processor-qa-40k92@1.0.0","cfg":"40k92@1.0.0","rules":[{"id":"EFRuP@1.0.0","cfg":"none"},{"id":"092@1.0.0","cfg":"1.0.0"},{"id":"701@1.0.0","cfg":"1.0.0"}],"tenantId":"cbe"}]}],"tenantId":"cbe"}',
    ),
